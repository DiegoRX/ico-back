...
export class CreateTxDto {
  ...
  @ApiProperty({ description: 'Dirección del receptor ONDK', example: '0xb71de5d4cce44d86e2fb9df6c49bbc970be4d1f8' })
  ...
  @ApiProperty({ description: 'Hash de la transacción ONDK original', example: '0xb49aed9f947d6ca4b408619da9fd8fb9cbb9d2a5ad779445ce6ee0366d4af0c8' })
